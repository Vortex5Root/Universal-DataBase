...
> **Universal-DataBase** is a versatile software development kit designed to simplify database operations across SQLite and Redis. It provides a unified interface for CRUD operations, dynamic table creation, and model management, making it ideal for developers working with hybrid database systems.

| Problem | Solution |
| --- | --- |
| **Managing multiple database types with different APIs is complex.** | **Universal-DataBase provides a unified interface for SQLite and Redis, simplifying database operations.** |
...
Click on the following image to go to the Universal-DataBase Documentation:

<a href=./Documentation.md><img src="./img/wikipedia-svgrepo-com.svg" width=50></a>
...
<p align="center">
    ...
    <a href="https://github.com/PandemicOfNukes"><img src=https://avatars.githubusercontent.com/u/102427260?s=200&v=4 width=50 style="border-radius: 50%;"><br>PandemicOfNukes <br><b>        {Student}</b></a><br><br>
</p>
